        ...
        <li>
          <h3>
            ...
            <p>
              ...
              customers. We helped design and build a tool which enables highly
              targeted screen selection to suit the campaign goals.
            </p>
          </h3>
        </li>
        <li>
          <h3>
            ...
            <p>
              ...
              across all of their business units. Alembic helped the
        ...
        <li>
          <h3>
            ...
            <p>
              ...
              are using Class Solver to quickly create the perfect classes for
              their students.
            </p>
          </h3>
        </li>
        ...
        <li>
          <h3>
            ...
            <p>
              ...
              We leveraged the robustness of Elixir to manage the real-time
